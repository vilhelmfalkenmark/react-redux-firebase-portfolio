...
import {Editor, EditorState, RichUtils, convertToRaw, convertFromRaw,createFromBlockArray} from "draft-js";
...
export default class RichEditor extends React.Component {
  ...
  componentDidMount() { // <-- Sätter state i pappan på dirren så att
   this.props.content( // allt lirar om det är så att det är ett draft man kör
      ...
      <div className="RichEditor-root">
        ...
        <div className={className} onClick={this.focus}>
          <Editor
            ...
            // placeholder="En ny skön artikel..."
            ref="editor"
            spellCheck={true}
          />
        </div>
